declare namespace RestAPI {
  ...
  interface IInp<T extends {} = {}> {
    ...
    par?: T
    dataType?: Types
    data?: string | ArrayBuffer //ArrayBuffer does not works in ReactNative. WOrkaround is convert all to BASE64 (by means of thord party library, e.g. https://github.com/dankogai/js-base64) TArrayViews | Blob | DataView and other, see https://github.github.io/fetch/. !!! is not in React Native
  }
