...
import { connect, Store, InferableComponentEnhancerWithProps } from 'react-redux'
import { put, take } from 'redux-saga/effects'
import invariant from 'invariant'
import { actRoute } from 'rw-router/index'

export const createLoginButton: InferableComponentEnhancerWithProps<Login.ILoginButtonMapProps & Login.ILoginButtonDispatchProps, React.HTMLAttributes<{}>> = connect(
