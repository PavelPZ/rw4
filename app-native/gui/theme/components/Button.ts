...
export default (variables = variable) => {
	...
	const buttonTheme = {
		...
		".bordered": {
			".dark": {
				...
				borderColor: variables.colBtnWhite,
				borderWidth: variables.borderWidth * 2,
			},
			".light": {
				"NativeBase.Text": {
          color: variables.colBtnDark,
				},
				"NativeBase.Icon": {
					color: variables.colBtnDark,
				},
				...
				backgroundColor: "transparent",
				borderColor: variables.colBtnDark,
				borderWidth: variables.borderWidth * 2,
			},
			".primary": {
				"NativeBase.Text": {
		...
		".dark": {
			...
			backgroundColor: variables.colBtnWhite,
		},
		".light": {
			".transparent": {
				"NativeBase.Text": {
			...
			backgroundColor: variables.colBtnDark,
		},
    ...
    ".rounded": {
      ...
      '.small': {
		...
		flexDirection: "row",
		elevation: 2,
		shadowColor: platformStyle === "material" ? variables.colBtnWhite : undefined,
