...
(Screen11 as any).navigationOptions = {
  title: 'Screen11',
}

const Screen12 = () => <Text>Screen12</Text>


(Screen12 as any).navigationOptions = {
  title: 'Screen12'
}

const Screen2 = () => <Text>Screen2</Text>
