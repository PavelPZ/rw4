...
//const app1: React.SFC<any> = props => {
//  let tween: TweensPromise
//  return <div style={{ position: 'relative' }}>
//    <div
//      style={{ position: 'absolute', opacity: 0.3, top: 10, left: 10, width: 100, height: 100, backgroundColor: 'red' }}
//      ref={el => TweenLite.to(el, 2, { delay: 0.5, opacity: 1, top: 100, left: 100, width: 200, height: 200, onComplete: () => { }, ease: Elastic.easeOut.config(1, 0.3) })}
//    >
//    </div>
//    <div
//      style={{ position: 'absolute', opacity: 0.3, top: 300, left: 10, width: 100, height: 100, backgroundColor: 'red' }}
//      ref={el => tween = new TweensPromise().animate(el, 10, { delay: 0.2, opacity: 1, top: 400, left: 100, width: 200, height: 200 })}
//    >
//    </div>
//    <div style={{ position: 'absolute', top: 700 }} onClick={() => tween.abort() }>CANCEL</div>
//  </div>
//}
