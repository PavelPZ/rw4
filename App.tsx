...
import RouterProvider, { AppNavigator, initState } from './app-native/snack/navigation/navigation-redux2';
...
export const init = async () => {
  ...
  const reducers: App.IReducer = (state, action: any) => {
    return {
      ...
      //router: navReducer(state.router, action)
    }
  }
  ...
  const appMin = <ReduxProvider store={store} ><RouterProvider/></ReduxProvider>
